...
-- Insert a couple of reviews for the sample product                                                                                                    
INSERT INTO reviews (product_id, rating, review_text, reviewer_name)                                                                                    
VALUES                                                                                                                                                  
    (1, 5, 'Excellent product, very high quality!', 'John Doe'),                                                                                        
    (1, 4, 'Good value for money, but could be better.', 'Jane Smith'); -- This file contains initial data for the products table.
-- It is based on the static content from the original product details template.
